...
//        ProgramSlot resultPs=  instance.getProgramSlotByDate(getFormatedDate("2017-09-14"));
//        
...
//
//        instance.createSchedule(expectedPs);
//        ProgramSlot resultPs=  instance.getProgramSlotByDate(getFormatedDate("2018-09-14"));
//        
//        assertEquals(expectedPs.getDateofProgram(), resultPs.getDateofProgram());
//        assertEquals(expectedPs.getDuration(), resultPs.getDuration());
//        assertEquals(expectedPs.getStartTime(), resultPs.getStartTime());
...
//        ScheduleRESTService instance = new ScheduleRESTService();
//        
//        ProgramSlot editProgramSlot = instance.getProgramSlotByDate(getFormatedDate("2017-09-29"));
//        
//        if(editProgramSlot == null ){
//        
//                instance.createSchedule(sampleProgramSlot);
//                editProgramSlot = instance.getProgramSlotByDate(getFormatedDate("2017-09-29"));
//        }
//        
...
//                instance.createSchedule(sampleProgramSlot);
//        }
//        instance.deleteSchedule(123);
//        ProgramSlot result= instance.getProgramSlotByDate(getFormatedDate("2017-09-28"));
//        assertNull(result);
//        
//    }
//    
